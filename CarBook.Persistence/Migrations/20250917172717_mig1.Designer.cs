...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarBook.Domain.Entites.Answer", b =>
                {
            ...
            modelBuilder.Entity("CarBook.Domain.Entites.Question", b =>
                {
                    b.Property<int>("QuestionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SubBrandCategory")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("CarBook.Domain.Entites.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarBook.Domain.Entites.Answer", b =>
                {
                    b.HasOne("CarBook.Domain.Entites.Question", "Question")
                        .WithMany("Answers")
                        .HasForeignKey("QuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CarBook.Domain.Entites.User", "User")
                        .WithMany("Answers")
